...
<template>
    <div class="right slider">
        ...
        <div class="right-content">
            <div class="item">
                <div class="num">{{articlesList.length}}</div>
                文章数
            </div>
            <div class="item">
                <div class="num">{{articleClassList.length}}</div>
                分类数
            </div>
            <div class="item">
                <div class="num">{{labelList.length}}</div>
                标签数
            </div>
        </div>
        <div class="tags">
            ...
            <div class="tags">
                ...
                <br><br>
                <el-tag size="medium" v-for="(tag,index) in labelList" :key="index" class="tag" type="primary">
                    {{tag.name}}
                </el-tag>
            </div>
        </div>
